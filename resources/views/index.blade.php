    ...
    <div class="container mx-auto px-4">
        ...
        <div class="flex flex-col lg:flex-row my-10">
            <div class="recently-reviewed w-full lg:w-3/4 mr-0 lg:mr-32">
                ...
                <div class="receltny-reviewed-container space-y-12 mt-8">
                    <div class="game bg-gray-800 rounded-lg shadow-md flex px-6 py-6">
                        ...
                        <div class="ml-12">
                            ...
                            <p class="mt-6 text-gray-400 hidden lg:block">
                                Lorem ipsum dolor sit amet consectetur adipiscing elit, eget blandit et porttitor aptent sociosqu, donec sapien hendrerit etiam fringilla dignissim. Potenti hendrerit enim nullam consequat convallis lacus eget aliquam, leo eu odio at accumsan pharetra tempor platea, tempus euismod ridiculus nam dignissim orci netus. Molestie duis scelerisque leo neque varius nulla magna blandit porttitor fusce, dictumst in litora iaculis platea mollis dictum condimentum accumsan, eget praesent volutpat ornare tincidunt hac pulvinar maecenas id.
                            </p>
                        </div>
                    </div>
                    <div class="game bg-gray-800 rounded-lg shadow-md flex px-6 py-6">
